...
import { debounce, getVersion, nFormatter } from "../excalidraw/utils";
import {
  getElementsStorageSize,
  getTotalStorageSize,
} from "./data/localStorage";
import { DEFAULT_VERSION } from "../excalidraw/constants";
import { t } from "../excalidraw/i18n";
import { copyTextToSystemClipboard } from "../excalidraw/clipboard";
import type { NonDeletedExcalidrawElement } from "../excalidraw/element/types";
import type { UIAppState } from "../excalidraw/types";
