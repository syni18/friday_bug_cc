/**
 * LocalData file deals with saving data state (appState, elements, images, ...)
...
import type { LibraryPersistedData } from "../../excalidraw/data/library";
...
import type { MaybePromise } from "../../excalidraw/utility-types";
